...
Comparison = ['Italy', 'Turkey', 'Spain', 'United Kingdom']
...
# # Manual update
# dfCases.iloc[10, 1] = 7402
# dfDeath.iloc[11, 1] = 108
...
# # Export charts as tables
# dfDeath.to_excel("CovidDeath.xlsx")
# dfCases.to_excel("CovidCases.xlsx")
